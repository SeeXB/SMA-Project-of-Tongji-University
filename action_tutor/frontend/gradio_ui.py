...
def run_pipeline(base_url: str, student_id: str, notes: str, exercise_logs_raw: str, error_history_raw: str) -> tuple[str, str]:
	try:
		trace = {
		...
		return json.dumps(weak, ensure_ascii=False, indent=2), nudge
...
def build_ui() -> gr.Blocks:
	with gr.Blocks(title="Action-Oriented Tutor") as demo:
		...
		base_url = gr.Textbox(value="http://127.0.0.1:5000", label="Flask Backend URL")
